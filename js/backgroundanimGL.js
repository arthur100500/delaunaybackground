...
Math.avg = function (a, b, c) { return (a + b + c) / 3; }
...
function main() {
  ...
  verts = new Float32Array(triangles.length * 6)
  ...
  indicies = new Int32Array(trianglescnt);
  ...
  function updateAndRedraw() {
    ...
    gl.drawArrays(gl.TRIANGLES, 0, trianglescnt);
    setTimeout(function () { window.requestAnimationFrame(updateAndRedraw) }, 10);
  }
